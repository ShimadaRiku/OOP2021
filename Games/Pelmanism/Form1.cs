    ...
    public partial class FormGame : Form
    {
        ...
        private void CardsButtons_Click(object sender, EventArgs e)
        {
            ...
            if (player.OpenCounter == 0)
            {
                ...
                labelGaidance.Text = "もう一度めくってください";
            ...
            }else if(player.OpenCounter == 1)
            {
                ...
                {
                    labelGaidance.Text = "カードは一致しました。次のカードをめくってください。";
                }
                else
                {
                    labelGaidance.Text = "カードは不一致です。次のカードをめくってください。";
                }
                //プレイヤーのカード情報をリセットする
                player.Reset();
                ...
                {
                    labelGaidance.Text = "全部のカードが一致しました。お疲れさまでしたｗ";
                    timer1.Stop();
        ...
        /// <returns>trule:一致  false:不一致</returns>
        ...
        private void buttonStart_Click(object sender,EventArgs e)
        {
            ...
            labelGaidance.Text = "クリックしてカードをめくってください。";
        }
        ///<summary>
        ///カードを伏せる
        /// </summary>
